...
this paper. General-purpose helpers such as `run_full_detection_bundle.py` are
therefore intentionally not duplicated here, even when manuscript-specific
sensitivity scripts retain imports from that broader pipeline.
...
- `manuscript_analysis/spiral_phase_model/`: spiral phase-field model implementation, model-fitting batch scripts, and reconstructed phase-cube generation code for the manuscript model section.
